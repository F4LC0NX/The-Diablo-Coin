...
#define QAPP_ORG_NAME "Diablo"
#define QAPP_ORG_DOMAIN "Diablocoinx666.org"
#define QAPP_APP_NAME_DEFAULT "Diablo-Qt"
#define QAPP_APP_NAME_TESTNET "Diablo-Qt-testnet"
