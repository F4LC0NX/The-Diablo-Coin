...
{
    const char* pszTimestamp = "The Times 03/Dec/2025 Bitcoin is name of the game for new generation of firms";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 30 * 60; // 30 minutes instead of 1 day
        consensus.nPowTargetSpacing = 1 * 40; // 40 seconds
        ...
        genesis = CreateGenesisBlock(1514999494, 25023712, 0x1e00ffff, 4, 50000 * COIN);
        ...
        nIssueQualifierAssetBurnAmount = 10000 * COIN;
        nIssueSubQualifierAssetBurnAmount = 1000 * COIN;
        nIssueRestrictedAssetBurnAmount = 15000 * COIN;
